...
type ContainerSpec struct {
	...
	// Bundle reference to use for getting the image. If this is set image field
	// specifies image inside the bundle
	Bundle string `protobuf:"bytes,12,opt,name=bundle,proto3" json:"bundle,omitempty"`
}
...
func (m *ContainerSpec) MarshalTo(data []byte) (int, error) {
	...
	if len(m.Bundle) > 0 {
		data[i] = 0x62
		i++
		i = encodeVarintSpecs(data, i, uint64(len(m.Bundle)))
...
var fileDescriptorSpecs = []byte{
	...
	,
}
