...
type EncryptedRecord_Algorithm int32

const (
	NotEncrypted                 EncryptedRecord_Algorithm = 0
	NaclSecretboxSalsa20Poly1305 EncryptedRecord_Algorithm = 1
)

var EncryptedRecord_Algorithm_name = map[int32]string{
	0: "NONE",
	1: "SECRETBOX_SALSA20_POLY1305",
}
var EncryptedRecord_Algorithm_value = map[string]int32{
	"NONE": 0,
	"SECRETBOX_SALSA20_POLY1305": 1,
}

func (x EncryptedRecord_Algorithm) String() string {
	return proto.EnumName(EncryptedRecord_Algorithm_name, int32(x))
}
func (EncryptedRecord_Algorithm) EnumDescriptor() ([]byte, []int) {
...
// EncryptionConfig defines the cluster-wide settings for encrypting data
type EncryptionConfig struct {
	// ManagerUnlockKey defines the key that locks a manager at rest.  This is the
	// key encrypting key (KEK) that will encrypt the manager TLS keys at rest and
	// the raft encryption keys at rest.  If not provided, then managers will be
	// unlocked (will not require a key to start up from a shut down state).
	ManagerUnlockKey []byte `protobuf:"bytes,1,opt,name=manager_unlock_key,json=managerUnlockKey,proto3" json:"manager_unlock_key,omitempty"`
}

func (m *EncryptionConfig) Reset()                    { *m = EncryptionConfig{} }
func (*EncryptionConfig) ProtoMessage()               {}
func (*EncryptionConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{32} }
...
func (*RemovedNode) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{40} }

type EncryptedRecord struct {
	Algorithm EncryptedRecord_Algorithm `protobuf:"varint,1,opt,name=algorithm,proto3,enum=docker.swarmkit.v1.EncryptedRecord_Algorithm" json:"algorithm,omitempty"`
	Data      []byte                    `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	Nonce     []byte                    `protobuf:"bytes,3,opt,name=nonce,proto3" json:"nonce,omitempty"`
}

func (m *EncryptedRecord) Reset()                    { *m = EncryptedRecord{} }
func (*EncryptedRecord) ProtoMessage()               {}
func (*EncryptedRecord) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{41} }
...
func init() {
	...
	proto.RegisterType((*EncryptedRecord)(nil), "docker.swarmkit.v1.EncryptedRecord")
	...
	proto.RegisterEnum("docker.swarmkit.v1.EncryptedRecord_Algorithm", EncryptedRecord_Algorithm_name, EncryptedRecord_Algorithm_value)
}
...
func (m *EncryptedRecord) Copy() *EncryptedRecord {
	if m == nil {
		return nil
	}
...
func (this *EncryptedRecord) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&api.EncryptedRecord{")
	s = append(s, "Algorithm: "+fmt.Sprintf("%#v", this.Algorithm)+",\n")
	s = append(s, "Data: "+fmt.Sprintf("%#v", this.Data)+",\n")
...
func (m *EncryptionConfig) MarshalTo(data []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ManagerUnlockKey) > 0 {
		data[i] = 0xa
		i++
		i = encodeVarintTypes(data, i, uint64(len(m.ManagerUnlockKey)))
		i += copy(data[i:], m.ManagerUnlockKey)
	}
	return i, nil
}
...
func (m *EncryptedRecord) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *EncryptedRecord) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *EncryptedRecord) Size() (n int) {
	var l int
	_ = l
	if m.Algorithm != 0 {
		n += 1 + sovTypes(uint64(m.Algorithm))
...
func (this *EncryptedRecord) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&EncryptedRecord{`,
		`Algorithm:` + fmt.Sprintf("%v", this.Algorithm) + `,`,
		`Data:` + fmt.Sprintf("%v", this.Data) + `,`,
...
func (m *EncryptionConfig) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ManagerUnlockKey = append(m.ManagerUnlockKey[:0], data[iNdEx:postIndex]...)
			if m.ManagerUnlockKey == nil {
				m.ManagerUnlockKey = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *EncryptedRecord) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EncryptedRecord: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EncryptedRecord: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				m.Algorithm |= (EncryptedRecord_Algorithm(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorTypes = []byte{
	...
	,
}
